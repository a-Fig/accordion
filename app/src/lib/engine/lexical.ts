 ...
 * older folded blocks to detect relevance (the "pre-unfold" step of the conductor).
 *
 ...
 */
export function matchBlocks(ids: Set<string>, candidates: Block[]): Map<string, string> {
